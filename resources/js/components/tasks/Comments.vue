                            ...
                            <div v-for="(comment, index) in comments" :key="index">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="comment-icons">
                                        <i class="fa fa-edit text-success comment-icon" v-if="current_permissions.has('comments-update') && current_user.id === comment.user_id" @click="editComment(comment)"></i>
                                        <i class="fa fa-trash text-danger comment-icon" v-if="current_permissions.has('comments-delete') && current_user.id === comment.user_id" @click="deleteComment(comment)"></i>
                                    </div>
                                </div>
